...
(function($) {
	...
	Calendar.prototype._update = function() {
		var self = this;
		$('.cal-month-day').hover(function() { //显示pencil图标
				$('.cal-assign', this).removeClass('hide');
			}, function() {
				$('.cal-assign', this).addClass('hide');
			});
		$(".cal-assign").on("click", function(e) {
			self.options.day = $('[data-cal-date]', $(this).closest('.cal-cell')).data('cal-date');
			//查找绑定的 time grid
			if (self.options.dateCapture) {
				self.options.dateCapture.data('date-capture').loadData(self.options.day);
			}
			e.stopPropagation();
		});
